...
function Page() {
  return (
    <div className="px-5 pt-2 pb-8">
      <ScreenHeader title="All transactions" subtitle="Admin" />
      <h1 className="text-xl font-bold">All transactions</h1>
      <p className="mt-1 text-xs text-muted-foreground">Full audit log of deposits, withdrawals, buys and earnings.</p>
