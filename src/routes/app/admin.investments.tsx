...
function Page() {
  return (
    <div className="px-5 pt-2 pb-8">
      <ScreenHeader title="Investments" subtitle="Admin" />
      <h1 className="text-xl font-bold">Investments</h1>
      <p className="mt-1 text-xs text-muted-foreground">Monitor every active and completed investment across the platform.</p>
