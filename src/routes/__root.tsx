...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Vendora — Trade & Earn" },
      { name: "description", content: "Vendora is a global trading and investment platform that allows users to buy, sell, and earn from digital product assets within a unified wallet system." },
      { name: "author", content: "Vendora" },
      { property: "og:title", content: "Vendora — Trade & Earn" },
      ...
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/qkkfgkOWgfgubahZTD4yptwyVXo2/social-images/social-1777301892541-ChatGPT_Image_Apr_27,_2026,_02_44_31_PM.webp" },
    ],
    links: [
      {
        rel: "stylesheet",
